...
This project is indexed by GitNexus as **duckdb-query** (14023 symbols, 27251 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
