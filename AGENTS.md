...
This project is indexed by GitNexus as **duckdb-query** (14254 symbols, 27731 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
