...
- [ ] 1. 创建 DuckDB 类型工具模块
  - [ ] 1.1 创建 `frontend/src/new/utils/duckdbTypes.ts`
...
- [ ] 4. 创建类型冲突指示器组件
  - [ ] 4.1 创建 `frontend/src/new/Query/components/TypeConflictIndicator.tsx`
...
- [ ] 5. 创建类型冲突对话框组件
  ...
  - [ ] 5.2 编写 TypeConflictDialog 属性测试
    - **Property 10: Dialog header shows correct conflict count**
    - **Validates: Requirements 11.3, 11.4**

- [ ] 6. 集成到 JoinQueryPanel
  - [ ] 6.1 更新 `frontend/src/new/Query/JoinQuery/JoinQueryPanel.tsx`
    - 导入并使用 `useTypeConflict` Hook
    - 构建 `columnPairs` 数组传递给 Hook
    - 在 JoinConnector 旁边添加 TypeConflictIndicator
    - 添加 TypeConflictDialog 组件
    - 更新执行逻辑：有未解决冲突时打开对话框
    - _Requirements: 4.1, 4.2, 4.3, 4.4_

  - [ ] 6.2 编写 JoinQueryPanel 集成测试
    - **Property 5: Unresolved conflicts block execution**
    - **Validates: Requirements 4.1, 4.2**

- [ ] 7. 实现 SQL TRY_CAST 生成
  - [ ] 7.1 更新 JoinQueryPanel 的 `generateSQL` 函数
...
- [ ] 8. 添加国际化支持
  - [ ] 8.1 更新 `frontend/src/i18n/locales/zh/common.json`
    - 添加类型冲突相关的中文翻译
    - _Requirements: 6.4_

  - [ ] 8.2 更新 `frontend/src/i18n/locales/en/common.json`
    - 添加类型冲突相关的英文翻译
    - _Requirements: 6.4_
