...
**文件**: `frontend/src/Query/DataGrid/components/FilterMenu.tsx`
...
**文件**: `frontend/src/Query/DataGrid/hooks/useDataGrid.ts`
...
**文件**: `frontend/src/Query/DataGrid/types.ts`
...
创建了完整的测试套件：`frontend/src/Query/DataGrid/hooks/__tests__/multiColumnFilter.test.ts`
...
- `frontend/src/Query/DataGrid/hooks/useDataGrid.ts` - 自定义筛选函数
- `frontend/src/Query/DataGrid/hooks/useColumnFilter.ts` - 列筛选状态管理
- `frontend/src/Query/DataGrid/components/FilterMenu.tsx` - 筛选菜单 UI
- `frontend/src/Query/DataGrid/types.ts` - 类型定义
- `frontend/src/Query/DataGrid/hooks/__tests__/multiColumnFilter.test.ts` - 测试
